  ...
  return (
    <>
      ...
      <div className="pt-6 sm:pt-8 md:pt-10 lg:pt-[50px] pb-6 sm:pb-8 md:pb-10 lg:pb-[50px] px-4 sm:px-6 md:px-8 lg:px-[150px]">
        ...
        {/* Products Grid */}
        <div className="w-full px-0 sm:px-0 md:px-0 lg:px-0 lg:py-0 py-4">
          {products.length === 0 ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-10 2xl:gap-[20px]">
                ...
                {products.map((product) => (
                  ...
                  <Link
                    ...
                    className="block"
                  >
                    <div className="overflow-hidden hover:shadow-lg transition-shadow duration-300 border border-gray-300 rounded p-1 w-full h-full">
                      <div className="w-full aspect-[26/15] sm:aspect-[26/15] md:aspect-[156/101] lg:aspect-[140/101] xl:aspect-[156/101]">
                        <img
                          src={product.image}
                          alt={product.name}
